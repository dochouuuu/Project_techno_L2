...
/**
 * @brief Converts a shape into its corresponding character representation.
 * @param s the shape to convert
 * @return the character representing the given shape
 **/
char shape_to_char(shape s);

/**
 * @brief Converts a direction into its corresponding character representation.
 * @param d the direction to convert
 * @return the character representing the given direction
 **/
char direction_to_char(direction d);

/**
 * @brief Converts a character into its corresponding shape.
 * @param c the character to convert
 * @return the shape corresponding to the given character
 **/
shape char_to_shape(char c);

/**
 * @brief Converts a character into its corresponding direction.
 * @param c the character to convert
 * @return the direction corresponding to the given character
 **/
